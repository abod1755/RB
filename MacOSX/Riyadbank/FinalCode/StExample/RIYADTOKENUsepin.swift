...
class RIYADTOKENUsepinViewController: UIViewController {
...
رقم التعريف الشخصي (الرمز السري) يتكون من أربعة أرقام، وهو كلمة المرور الرقمية التي تطلبها مؤسسة النقد العربي السعودي لبرنامج رمز التفعيل.
""" : """
        A PIN is a four-digit, numeric password required by SAMA for soft token applications.
        """
