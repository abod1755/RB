...
class RIYADTOKENChangepinViewController: UIViewController {
...
1 اقرأ الإعدادات.
2 اختر تغيير الرمز السري.
3 أدخل الرمز السري القديم الخاص بك.
4 أدخل الرمزمر السري الجديد المكون من 4 أرقام.
5 أعد تأكيد الرمز السري الجديد الخاص بك.
""" : """
        1. Click the Setting icon
        2. Select Change PIN
        3. Enter your old PIN.
        4. Enter a new 4-digit numeric PIN.
        5. Reconfirm your new PIN.
        """
